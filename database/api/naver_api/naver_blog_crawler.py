...
from database.utils.db_utils import get_engine, get_hospital_id_names
from database.utils.llm_utils import chunk_review_with_llm
from database.utils.embedding_utils import embed_texts        # wraps MiniLM
from sqlalchemy.exc import IntegrityError, OperationalError

from database.utils.db_utils import get_hospital_id_names_fixed
from database.api.naver_api.naver_api import search_naver_blog
...
if __name__ == "__main__":
    ...
    from database.api.naver_api.naver_blog_crawler import driver
    driver.quit()